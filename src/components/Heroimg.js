...
const Heroimg = () => {
  return (
    <div className="flex flex-col justify-center lg:flex-row lg:space-x-32  mx-auto  lg:mb-40  lg:mt-32 mt-24 font-Redrose " id="hero">
       <div className="text-3xl lg:text-5xl  text-gray-900 lg:mt-48 ">
